...
#define BMP_UPSCALE_FACTOR 0    //Set the Upscale factor for the BMP output (Set 0 to disable)
#define PNG_UPSCALE_FACTOR 4    //Set the Upscale factor for the PNG output (Set 0 to disable)
...
//Uncomment this if you are using SSD1306 display driver
#define USE_SSD1306
#define OLED_SDA 21
#define OLED_SCL 22
#define OLED_COMPINS 1      // If you have some issues with the image, try to change this with values between 1 and 4

//Uncomment this if you are using SSD1331 display driver
//#define USE_SSD1331
//#define OLED_SCLK 14
//#define OLED_MOSI 13
//#define OLED_MISO 12
